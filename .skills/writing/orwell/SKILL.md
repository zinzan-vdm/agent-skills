...
6. Confirm Orwell's baseline. Check terms, sentence structure, instructions, and technical exceptions.
...
7. Run a final pass. Check that each technical term is consistent, each instruction states the required action, and each exception is intentional.
